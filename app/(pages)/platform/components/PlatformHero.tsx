...
export function PlatformHero() {
  return (
    <Section variant="lightCream" className="py-20 border-b border-border">
      <ContainerFluid >
        <div className="max-w-2xl">
          <h1 className="text-[#112225] font-serif text-[44px] md:text-6xl lg:text-7xl leading-[1.1] mb-5">
            Strategic marketing platform that builds and executes
          </h1>

          <p className="text-[#112225] text-xl md:text-xl lg:text-xl font-sans max-w-xl leading-relaxed mb-10">
