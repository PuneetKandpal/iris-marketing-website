...
export function Comparison() {
  return (
    <Section className="max-w-7xl mx-auto px-4 py-20 font-sans text-[#1a2b2b]">
        <ContainerFluid>
            <div className="text-center mb-16 max-w-4xl mx-auto text-center">
                ...
                <h2 className="text-[40px] md:text-5xl lg:text-[56px] font-serif leading-[1.1] text-[#112225] mb-8">
                    Versus your current <br className="hidden sm:block" /> approach
                </h2> 
                <Button variant="blackcustom" size="lg" className="w-auto sm:w-auto">
                    Start for Free
                </Button>
                <p className="mt-12 text-2xl test-[#112225] font-serif">Manual Strategy and Execution</p>
            </div>
           

            <div className="grid grid-cols-1 lg:grid-cols-2 border border-gray-100 shadow-sm rounded-sm overflow-hidden">
                ...
                <div className="p-8 md:p-12 bg-[#efede7]">
