...
export function AboutHero() {
  return (
    <Section variant="lightCream" className="py-24 border-b border-iris-cream">
      <Container>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-iris-body mb-10 leading-relaxed">
    ...
    <Section className="py-24">
      <Container>
        <div className="text-center mb-16">
          ...
          <p className="text-iris-body text-lg max-w-2xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {team.map((member) => (
            <div key={member.name} className="flex flex-col items-center text-center">
              <div className="w-48 h-48 rounded-full bg-iris-teal text-white flex items-center justify-center mb-4 shadow-xl text-3xl font-semibold">
                {member.initials}
              </div>
              <h3 className="text-xl font-semibold">{member.name}</h3>
              <p className="text-iris-orange font-medium">{member.role}</p>
            </div>
          ))}
        </div>
      </Container>
