      ...
      <ContainerFluid className="text-center">
        <div className="text-left">
           <div className="flex flex-col md:flex-row justify-between items-start mb-16 gap-8">
              <h2 className="text-[40px] md:text-[40px] lg:text-5xl font-serif text-iris-dark leading-none tracking-tight max-w-md">
                We solve Strategy, Not Writing
              </h2>
              <p className="text-iris-teal text-base max-w-md leading-relaxed">
