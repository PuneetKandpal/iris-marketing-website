      ...
      <Container className="text-center">
        <div className="text-left">
           <div className="flex flex-col md:flex-row justify-between items-start mb-16 gap-8">
              <h2 className="text-5xl md:text-5xl lg:text-5xl font-serif text-[#112225] leading-none tracking-tight max-w-md">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#0B363C] p-12 min-h-[320px] flex flex-col justify-between text-white">
              ...
              <div className="bg-[#0E1A1C] p-12 min-h-[320px] flex flex-col justify-between text-white">
                 <span className="text-[56px] font-serif tracking-tighter">300%</span>
                 <p className="text-sm text-white">Organic traffic up</p>
              </div>
              <div className="bg-[#EE6D3B] p-12 min-h-[320px] flex flex-col justify-between text-white">
