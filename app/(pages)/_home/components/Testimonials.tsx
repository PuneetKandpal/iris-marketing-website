          ...
          <div className="md:col-span-9 relative">
            ...
            >
              {testimonialContent.map((item, index) => (
                <SwiperSlide key={index} className="bg-iris-light">
                  <div className="p-10 md:p-20 lg:p-10 flex flex-col justify-between h-full">
                    <div className="space-y-12">
                      ...
                      <div className="text-2xl md:text-4xl lg:text-4xl font-serif text-iris-dark leading-tight tracking-tight mb-5 md:mb-10 lg:mb-20">
                        “{item.quote}”
                      </div>
                    </div>
